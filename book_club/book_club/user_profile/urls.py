...
from book_club.user_profile.views import home, create_profile, edit_profile, view_profile, delete_user_profile, log_in, about
...
urlpatterns = (
    ...
    # path('profile/delete/', delete_user_profile, name='delete profile'),
